...
dir_path = '/Users/adamklaus/Documents/Personal/Develop/sportsreference/sportsreference/wnba/'
sys.path.append(dir_path)
sys.path.append('/Users/adamklaus/Documents/Personal/Develop/sportsreference/sportsreference/')
sys.path.append('/Users/adamklaus/Documents/Personal/Develop/sportsreference/')
...
def _retrieve_all_teams(year, season_file=None):
    ...
    For a given season, parses the specified wnba stats table and finds all
    ...
    """
    team_data_dict = {}
    utils.SEASON_START_MONTH

    if not year:
        year = utils._find_year_for_season('wnba')
        # Given the delays to the wnba season in 2020, the default season
